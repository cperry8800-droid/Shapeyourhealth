...
const demoWorkoutLog = [
  { name: "5x5 Foundation", type: "Strength", duration: 55, difficulty: "Hard", date: "2026-04-01", notes: "Felt strong on squats" },
  { name: "20-Min Torch", type: "HIIT", duration: 20, difficulty: "Moderate", date: "2026-04-02", notes: "Quick morning session" },
...
const demoSchedule = {
  ...
  "2026-04-11": { name: "Morning Flow", type: "Yoga", time: "8:00 AM" },
  "2026-04-12": { name: "Rest Day", type: "Rest Day", time: "" },
  "2026-04-13": { name: "Leg Day Legends", type: "Strength", time: "7:00 AM" },
};
